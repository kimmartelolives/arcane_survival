...
// ============================================================================
// 🔮 TUTORIAL LOADING SCREEN — "Preparing the Training Grounds"
// Same ultra-premium RPG overlay as LoadingScreen, retextured for the
// tutorial/onboarding flow. Ancient runes, layered sigils, star field,
// celestial rings, atmospheric fog. Fully responsive — desktop + mobile.
// ============================================================================
...
const SOLO_LINES = [
  ...
  'SUMMONING TARGET DUMMIES',
  'CALIBRATING THE BATTLE WARDS',
  'AWAKENING THE TUTORIAL SPIRITS',
  'INSCRIBING THE FIRST LESSONS',
  'SEALING THE NOVICE ARENA',
];

const TIPS_SOLO = [
  'Movement and Dash are the bedrock of every fight — get comfortable with them first.',
  'Target dummies don\'t hit back. Use them to learn your combos at your own pace.',
  'Every skill has a tell before it activates — watch for the windup.',
  'You can replay the tutorial anytime from the menu if you want a refresher.',
  'Take it slow. The training grounds aren\'t timed — there\'s no rush.',
  'Mastering the basics here pays off the moment you step into a real run.',
];
        ...
        <div className="ls-center">
          ...
          <div className="ls-bar-wrap">
            ...
            <div className="ls-bar-meta">
              ...
              <span>SUMMONING TARGET DUMMIES</span>
...
export default TutorialLoadingScreen;