...
const ET = [
  ...
  { r: 13, speed: 75,  hp: 90,  dmg: 25,  xp: 25,  color: '#e2e8f0', glow: '#94a3b8', boss: false },
  // 2. Fast/Assassin Minion (Mabilis, mataas damage)
  { r: 11, speed: 120, hp: 60,  dmg: 40,  xp: 35,  color: '#fb923c', glow: '#f97316', boss: false },
  // 3. Tanky/Elite Minion (Sobrang kunat at masakit)
  { r: 14, speed: 150, hp: 180,  dmg: 60,  xp: 50,  color: '#818cf8', glow: '#6366f1', boss: false },
  // 4. Generic Mini-Boss (Sobrang laki ng tinaas ng HP at Damage)
  { r: 27, speed: 65,  hp: 1200, dmg: 120, xp: 250, color: '#fbbf24', glow: '#f59e0b', boss: true },
];
          ...
          if (!isCoopActive || isHost) {
            ...
            for (let j = eng.enemies.length - 1; j >= 0; j--) {
              ...
              if (e.boss && ['demonKnight', 'archdemon', 'primordial', 'abyss'].includes(e.type)) {
                ...
                if (e.skillTimer <= 0) {
                  e.skillTimer = (e.type === 'abyss') ? 3.0 : 3.5; 
                ...
                if (e.type === 'abyss') {
                  ...
                  if (e.abyssShieldTimer > 0) {
                    ...
                    if (e.hp < e.prevHpFrame) e.hp = e.prevHpFrame; 
                  }
                  e.prevHpFrame = e.hp;
                }
              }
