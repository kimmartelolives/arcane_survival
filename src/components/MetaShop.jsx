...
export const SKINS_DB = [
  ...
  { id: 'shadow', name: 'Harbinger of the Void Realm', desc: 'A master of forbidden sorcery who draws power from the endless depths of the Void.', cost: 20000, glow: '#ef4444', colors: { c: '#991b1b', robe: '#450a0a', brim: '#7f1d1d' } },
  { id: 'igris', name: 'Abyssal Dreadlord', desc: 'A feared commander born from the endless abyss, clad in cursed armor and wreathed in crimson darkness.', cost: 23500, glow: '#dc2626', colors: { c: '#262626', robe: '#0a0a0a', brim: '#171717' } },
  { id: 'pyro', name: 'Demon of the Ashen Flare', desc: 'An infernal entity forged within primordial flames, leaving only ash in its wake.', cost: 25000, glow: '#f97316', colors: { c: '#ef4444', robe: '#7f1d1d', brim: '#fca5a5' } },
  { id: 'archmage', name: 'The Arcane Archon', desc: 'A legendary master of magic whose command over the arcane eclipses all mortal understanding.', cost: 25000, glow: '#fbbf24', colors: { c: '#fef08a', robe: '#b45309', brim: '#fef9c3' } },
  { id: 'sakura', name: 'Roseheart Sovereign', desc: 'Commands an endless storm of enchanted petals.', cost: 27000, glow: '#ec4899', colors: { c: '#f472b6', robe: '#ec4899', brim: '#fdf2f8' } },
  { id: 'pink_wings', name: 'Seraph of the Pink Eclipse', desc: 'A celestial sovereign whose wings paint the heavens in radiant pink light.', cost: 27000, glow: '#fb7185', colors: { c: '#fb7185', robe: '#f472b6', brim: '#fff5fa' } },
  { id: 'remembrance', name: 'Starlit Elegy', desc: 'Beyond time, beyond fate. The supreme manifestation of ancient elven magic and eternal memories.', cost: 28500, glow: '#60a5fa', colors: { c: '#f8fafc', robe: '#1e1b4b', brim: '#e0f2fe' } },
  { id: 'emperor', name: 'The Black Monarch', desc: 'A legendary tyrant whose shadow eclipsed the heavens themselves.', cost: 28500, glow: '#dc2626', colors: { c: '#171717', robe: '#0a0a0a', brim: '#050505' } },
  { id: 'infernal', name: 'Infernal Eclipse Sovereign', desc: 'The supreme ruler of the Eternal Eclipse. Cloaked in abyssal flames, every step bends darkness itself to their command.', cost: 28500, glow: '#e11d48', colors: { c: '#1f101a', robe: '#09050e', brim: '#1f0510' } },
  { id: 'empress', name: 'Empress of the Blushing Petals', desc: 'A divine guardian shrouded in radiant petals. Entire battlefields fall silent beneath her breathtaking grace.', cost: 30000, glow: '#fb7185', colors: { c: '#ffe4e6', robe: '#ffffff', brim: '#fda4af' } },
  { id: 'leviathan', name: 'Leviathan Empress of the Sacred Tide', desc: 'A divine Valkyrie chosen by Leviathan. Surrounded by celestial oceans, floating crystals, and holy tides that embody absolute grace and overwhelming power.', cost: 30000, glow: '#38bdf8', colors: { c: '#e0f2fe', robe: '#ffffff', brim: '#0284c7' } },
  { id: 'frieren', name: 'Mirrored Lotus: Eternal Remembrance', desc: 'A celestial relic born from mirrored lotus petals and drifting forget-me-not blossoms, reflecting an endless cycle of eternal promises and undying love.', cost: 30000, glow: '#60a5fa', colors: { c: '#f8fafc', robe: '#0f172a', brim: '#e0f2fe' } },
];
